...
/// that has to exist before the first screen: whether this device is
/// subscribed.
///
/// It runs alongside the beat rather than after it, so warming up costs no
/// extra time.
class SplashBloc extends Bloc<SplashEvent, SplashState> {
  ...
  /// screen. The entitlement then starts from what is in memory, which errs
  /// towards letting the user convert rather than towards charging them.
