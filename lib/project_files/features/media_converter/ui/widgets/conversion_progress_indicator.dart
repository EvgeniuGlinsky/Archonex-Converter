...
///
/// A `null` [progress] means FFmpeg could not tell how long the input is, so
/// the bar runs indeterminate and the percentage is hidden rather than shown
/// as a made up number.
